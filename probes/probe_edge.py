# -*- coding: utf-8 -*-
"""edge-tts 高质量中文语音 -> 英文翻译 闭环验证(真实应用场景:高保真中文人声)。"""
import json, time, urllib.request

BASE = "http://127.0.0.1:28099"
OUT_DIR = "/workspace/llama.cpp-omni/tools/omni/output_probe_edge"
WAVS = [
    "/workspace/llama.cpp-omni/tools/omni/assets/my_test/edge_zh_1.wav",  # 今天天气很好,我们一起去公园散步吧。
    "/workspace/llama.cpp-omni/tools/omni/assets/my_test/edge_zh_2.wav",  # 我明天早上八点要去北京开会,请帮我订一张高铁票。
]
...
def main():
    ...
    print()
    print("参考(中文原文):")
    print("  1. 今天天气很好,我们一起去公园散步吧。")
    print("  2. 我明天早上八点要去北京开会,请帮我订一张高铁票。")
